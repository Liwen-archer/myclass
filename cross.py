...
def main():
    ...
    X_train_task, y_train_task, X_test, y_test = utils.preprocess(
    ...
    model, optimizer, criterion_tar, criterion_task, best_model, best_optimizer = utils.initialize_training(
        prop)
